...
function tshowcaseshortcodegenerate() {
	...
	if(document.getElementById('multiple').checked) { 
		...
		document.getElementById('ctaxonomy').setAttribute("multiple","multiple");
		...
		document.getElementById('ctaxonomy').removeAttribute("multiple","multiple");
	...
	var ctaxonomy = tshowcase_getSelectValues(document.getElementById('ctaxonomy'));
	var relation = tshowcase_getSelectValues(document.getElementById('relation'));
	var filtersourcegrid = tshowcase_getSelectValues(document.getElementById('filter-source'));
	var filtersourcehover = tshowcase_getSelectValues(document.getElementById('filter-source-hover'));
	...
	jQuery('#what2display input').each(function(){
		if (jQuery(this).is(':checked')) {
            display=display+jQuery(this).val()+',';
	...
	if(pagination!='false') {
		shortcodeinner += " pagination='"+pagination+"'";
	}
	...
	if(ctaxonomy!="0" && ctaxonomy!="") {
	 	shortcodeinner += " ctaxonomy='"+ctaxonomy+"'";	
	}
	...
	if(filtersourcegrid!=""){
		shortcodeinner += " filter-source='"+filtersourcegrid+"'";
	}
	if(filtersourcehover!=""){
		shortcodeinner += " filter-source='"+filtersourcehover+"'";
	}
	...
	if(layout=="table") {
		...
		if(tableheader.checked){
			display += ','+tableheader.value;
		}
...
function tshowcasepreset() {
	...
	if(preset=='white-card-grid') {
		layout.value = "grid";
		imgstyle.value = "img-square";
		gridstyling.value = "white-card-theme";
		composition.value = "img-above";
		imgeffect.value = "";
		textalign.value = "text-left";
		columns.value = "3-columns";
